package
{
	...
	public class PreloadFrame extends MovieClip
	{
		...
		private function initilize():void
		{
			...
			//var music:Sound = new Sound(new URLRequest('https://dl.dropboxusercontent.com/u/11377077/ashes/baalmusic.mp3'));
			//music.play();
		...
		{
			inited = true;
			var mainClass:Class = Class(getDefinitionByName('TestStage'));
			if (mainClass)
			{
