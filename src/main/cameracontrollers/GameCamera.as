package cameracontrollers 
{
	...
	public class GameCamera 
	{
		...
		public function setTracingObject(target:Entity):void
		{
			this.target = target;
		...
		private function initilize():void 
		{
			...
			_camera.lens.near = 1;
			controller = new HoverController(camera, null, 180, 35, cameraModel.baseDitance, 4);
